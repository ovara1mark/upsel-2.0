...
export const PreLoader = () => {
  ...
  return (
    <section className="flex flex-col items-center  bg-upsel-light-black h-[100vh] w-[100%] overflow-x-hidden pt-[18%] ym:pt-[13%] md:pt-[7%]">
      <div className="flex z-auto overflow-x-hidden preloader-banner h-[3.6rem] w-[80rem] md:w-[90rem] lg:w-[105rem] xl:h-[3.6rem]">
        <Marquee speed={180}>
      ...
      {/* We are Upsel */}
      <div className=" gap-[2rem] font-bold text-center  md:flex md:items-center md:justify-between my-[18%] ym:my-[10%] sm:my-[7%] md:my-[5%] lg:my-[0%] lg:py-[2rem]">
        <p className=" text-[3rem] text-upsel-white ym:text-[3.5rem] md:text-[4.25rem] font-customTwo">
          We are
        </p>
        <div className="bg-upsel-white border-[12px] p-0 m-0 border-upsel-light-purple md:border-[24px]">
          <span className="font-customTwo border-[6px] p-0 m-0 border-upsel-blue text-[4rem] ym:text-[4.5rem] md:text-[7.25rem] md:border-[12px]">
            UPSEL
          </span>
        </div>
      </div>
